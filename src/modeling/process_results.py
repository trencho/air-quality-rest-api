...
async def save_errors(city_name: str, sensor_id: str, pollutant: str, model_name: str, y_true: Series,
...
async def save_results(city_name: str, sensor_id: str, pollutant: str, model_name: str, dataframe: DataFrame) -> None:
    dataframe.to_csv(
